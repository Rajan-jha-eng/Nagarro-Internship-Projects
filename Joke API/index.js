...
app.set('views', "C:\\Users\\admin\\Desktop\\backend\\jokeapi\\view");
...
app.get("/", (req, res) => {
    ...
    .then(function(response) {
        ...
        res.render('pages/display', {id: id, joke: joke});
    });
});
...
app.post("/joke", (req, res) => {
    ...
    con.query(searchQuery, (err, results) => {
        ...
        if(results.length != 0)
            res.render('pages/display', {id: results[0]["id"], joke: results[0]["joke"]});
